        ...
        <>
            <div className="sm:flex flex-row px-[5%]  py-[10%]">
                <div className="relative sm:w-[50%] w-[100%]">
                    ...
                    <div className="absolute top-[30%] left-[30%] h-[60%] w-[60%] ">
                ...
                <div className="sm:flex flex-col sm:w-[50%] w-[100%]">
                    ...
                    <div className="sm:flex flex-row gap-4">
                        <div >
                        <GiCircleClaws className="text-[#EF4444] text-[40px]" />
                        </div>
                        <div>
                        ...
                        <div className="pt-[10%]">
                        <button className="text-[18px] border h-[50px] font-bold text-[#12465B] w-[200px] rounded-lg hover:bg-[#12465B] hover:text-white">Get in touch</button>
                        </div>
                        </div>
